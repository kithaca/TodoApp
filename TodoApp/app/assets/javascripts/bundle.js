	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('input', { type: 'text', name: 'todo[title]', value: this.state.title,
	        ...
	        React.createElement('input', { type: 'text', name: 'todo[body]', value: this.state.body,
	          onChange: this.updateBody }),
	        React.createElement('input', { type: 'submit', value: 'Create New Todo' })
	      )
	    );
	  }
	});
